  ...
  const routes = [
    {
      ...
      description:
        "A nice and long route through a known park in Aveiro. Explore the beautiful parks and streets of this charming neighborhood.",
    ...
    },
    {
      ...
      description:
        "A scenic route along the famous Costa Nova beach with its colorful striped houses.",
    ...
    },
    {
      ...
      description:
        "A route that takes you through the charming streets of Aveiro, perfect for a leisurely ride.",
